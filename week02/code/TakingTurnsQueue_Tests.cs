...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Returned sue instead of Bob - bug found in PersonQueue class in the enqueue method - enqueue inserted person at begining of queue instead of the back.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Returned Tim instaed of sue 
    ...
    // Defect(s) Found:  Returned Sue instaed of tim 
